        ...
        var OtherMenu = PopTartView.extend({
            ...
            initialize: function () {
                ...
                this._menuModel = {
                    ...
                    convertToV2DisplayName: DashboardV2Helper.isDashboardAppFeatureEnabled() ? _("Clone in Dashboard Studio").t() : _("Clone in Dashboard App (beta)").t(),
                    convertToV2AndNewAlert: DashboardV2Helper.isDashboardAppFeatureEnabled()
                };
            },
            events: {

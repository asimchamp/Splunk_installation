            ...
            template:
                '<div class="inputform_wrapper">\
                    ...
                    available for monitoring depend on the system libraries installed. Microsoft and third-party vendors provide performance libraries.").t() %> \
                                    <a class="external" href="<%- localHelpLink %>" target="_blank" rel="noopener noreferrer"> <%= _("Learn More").t() %> </a>\
                    </p> \
                    <% } else { %>\
                    <p> \
                    ...
                    <a class="external" href="<%- remoteHelpLink %>" target="_blank" rel="noopener noreferrer"> <%= _("Learn More").t() %> </a> \
                    </p>\
                    <p>\

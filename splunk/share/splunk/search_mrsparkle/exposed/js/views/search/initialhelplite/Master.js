                ...
                <div class="columns">\
                    ...
                    <% } %>\
                        <ul class="howto">\
                            ...
                            <li><a href="<%- gettingStartedRoute %>" class="external" target="_blank" rel="noopener noreferrer" title="<%- _("Getting Started").t() %>"><%- _("Getting Started").t() %></a></li>\
                            <li><a href="<%- searchExamplesRoute %>" class="external" target="_blank" rel="noopener noreferrer" title="<%- _("Search Examples").t() %>"><%- _("Search Examples").t() %></a></li>\
                            <li><a href="http://www.splunk.com/view/SP-CAAAN57" class="external" target="_blank" rel="noopener noreferrer" title="<%- _("Video Product Tour").t() %>"><%- _("Video Product Tour").t() %></a></li>\
                        </ul>\
                    </div>\
                </div>\
            '

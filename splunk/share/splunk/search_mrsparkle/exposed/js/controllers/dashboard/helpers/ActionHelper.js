    ...
    cloneDashboardInStudio
        ...
        var ActionHelper = {
            ...
            openInV2: function (model, collection, deferreds) {
                if (DashboardV2Helper.isDashboardAppFeatureEnabled()) {
                    ActionHelper.clone(model, collection, deferreds, cloneDashboardInStudio);
                } else {
                    var app;
                    if (DashboardV2Helper.isDashboardViewAvailable()) {
                        app = splunkUtilsConfig.app;
                    } else {
                        app = DashboardV2Helper.getDashboardV2AppName();
                    }
                    var urlBase = 'app/' + app + '/dashboard';

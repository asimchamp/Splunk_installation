    ...
    function ($, _, Backbone, ViewsCollection, DashboardModel) {
        return ViewsCollection.extend({
            ...
            sync: function (method, collection, options) {
                ...
                var baseSearch;
                if (options.enableSplunkDashboardAppFeature) {
                    baseSearch = '(isDashboard=1 AND (rootNode="dashboard" OR rootNode="form" OR rootNode="view" OR rootNode="html") AND isVisible=1)';
                } else {
                    baseSearch = '(isDashboard=1 AND ((rootNode="dashboard" AND version!=2) OR rootNode="form" OR rootNode="view" OR rootNode="html") AND isVisible=1)';
                }

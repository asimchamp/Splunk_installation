...
class EnableJQuery2(base_config.Config):
    def __init__(self, session_key):
        ...
        quarantine_files_settings = config_utils.get_quarantine_files_settings(session_key)
        self.should_restrict = not normalizeBoolean(quarantine_files_settings[self.setting])
    def get_paths_to_restrict(self, base_path):
        ...
        paths_to_restrict = [
            ...
            os.path.join(web_base_path, 'build', 'pages', 'lite', 'dashboard.js'),
    ...
    def get_restricted_web_build_paths(self, web_base_path):
        candidate_dirs = [
            ...
            os.path.join(web_base_path, 'build', 'pages', 'lite'),
        ]
